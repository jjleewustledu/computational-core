...
__copyright__ = "(c) 2021 John J. Lee"

__basedir__ = os.path.dirname(__file__)

if sys.version_info.major != PY_REQUIRED_MAJOR or sys.version_info.minor < PY_REQUIRED_MINOR:
    raise RuntimeError(
        "computational-core requires Python {}.{} or higher. But the current Python is: {}".format(
...
#excludes = "(^(computationalcore.handlers))|((\\.so)$)|(^(monai._C))"
